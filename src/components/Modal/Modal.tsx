    ...
    <div className="w-screen h-screen absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex items-center justify-center">
      ...
      <Block className="w-3xl z-10 p-5">
        ...
        <div>
          ...
          how fun you were to talk with even though we just knew each other for
          a couple of weeks, days even, alongside the million reels you sent me.
          Then we had our first date (which you didn't really know it was a date
          hehe) and everything has been magical ever since that.
        </div>
        ...
        <div>
          ...
          life. I've learnt a lot about you as a girl, as my girlfriend, and as
          a person. Learnt about the things you like and dislike. I've always
          admired you, even though you're younger than me, you've made me learn
          so much about life, how to do things properly, and most importantly,
          about love.
        </div>

        <div>
          While our relationship, like any other relationships, hasn't been
          smooth sailing sometimes, and mainly because of my immaturity, I love
          how you're able to communicate your feelings and how to handle some
        ...
        <div>
          ...
          for you can't simply be written with mere words and need thousands of
          words to just convey a fraction of what I feel. All I know is{" "}
